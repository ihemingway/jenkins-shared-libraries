...
def call(Map args) {
    ...
    emailext(
        body: """${env.JOB_NAME} - Build # ${env.BUILD_NUMBER} - ${args.status}:
                                            ...
                                            <td valign="top" style="line-height: 130%; color: rgb(96, 96, 96);">
                                                ...
                                                <ul>
                                                    ...
                                                    <li style="color: rgb(96, 96, 96);"><font color="#666666" face="Arial, Helvetica, sans-serif"><span style="font-size: 14px; color: rgb(96, 96, 96); line-height: 130%;"><strong style="color: rgb(96, 96, 96);">VCS Related:</strong> ${env.REPO} - [Branch or Tag] ${env.BRANCH}</span></font></li>
                                                                                                            ...
                                                                                                            <li style="color: rgb(96, 96, 96);"><font color="#7CC286" face="Arial, Helvetica, sans-serif"><span style="font-size: 14px; color: #7CC286; line-height: 130%;"><strong style="color: #7CC286;">Deployment was ${args.status}!</strong></span></font></li>
                                                                                                    </ul>
